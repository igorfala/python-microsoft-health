...
setup(
    ...
    # Author details
    author='Igor Fala',
    author_email='ifala88@gmail.com',
    ...
    keywords='API OAUTH Microsoft Health',
    ...
    install_requires=['oauthlib==2.0.0', 'requests==2.12.1', 'requests-oauthlib==0.7.0'],
